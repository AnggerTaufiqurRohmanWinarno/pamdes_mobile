...
class _TambahPelangganPageState extends State<TambahPelangganPage> {
  ...
  void submit() async {
    ...
    if (nama.isEmpty || username.isEmpty || password.isEmpty ||
        konfirmasi.isEmpty || alamat.isEmpty || telepon.isEmpty) {
    ...
    try {
      final result = await ApiService.tambahPelanggan({
        'name'                  : nama,
        'username'              : username,
        'password'              : password,
      ...
      if (result['status'] == 'success') {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Pelanggan berhasil ditambahkan'), backgroundColor: Colors.green),
        );
        // Kosongkan form
        ...
        final pesan = result['message'] ?? 'Gagal menambahkan pelanggan';
        ScaffoldMessenger.of(context).showSnackBar(
